...
class DeepSeekClient:
    ...
    def _trade_task_text(self) -> str:
        return (
            ...
            "结构不完美时优先给轻仓试探，避免空洞观望；只有在完全找不到可控止损位时才 hold，hold 时 reason 也要写明冲突与等待条件（20-50 字）。不得输出除 JSON 外的内容。"
        )
