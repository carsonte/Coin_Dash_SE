...
def test_api_decisions_with_committee_filter(monkeypatch):
    ...
    logger.log_decision("decision", "BTCUSDm", payload, result, None, None, model_name="qwen", committee_id=committee_id, weight=0.2)
    ...
    assert {"deepseek", "gpt-4o-mini", "qwen", "committee"} <= models
